...
//        log.info(a);
        ...
        for (int selectLength = 1; selectLength <= totalLength; selectLength++) {

            System.out.println("selectLength = " + selectLength);

            for (int startIndex = 0; startIndex <= selectLength; startIndex ++) {
                System.out.println("selectLength = "+selectLength+", startIndex = "+startIndex);
            }
            System.out.println();
